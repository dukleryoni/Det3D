...
train_anno = "data/KITTI/kitti_infos_train_resampled.pkl"
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        root_path=data_root,
        info_path=data_root + "/kitti_infos_train_resampled.pkl",
        ann_file=train_anno,
        class_names=class_names,
...
log_level = "INFO"
work_dir = "experiments/SECOND_detection_20200113-132715"
load_from = "experiments/SECOND_detection_20200113-132715"
resume_from = "experiments/SECOND_detection_20200113-132715/latest.pth"
