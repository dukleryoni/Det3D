...
db_sampler = dict(
    type="GT-AUG",
    enable=True,
    db_info_path="data/lyft/dbinfos_train.pkl",
    sample_groups=[
        dict(car=1),
        dict(pedestrian=4),
        dict(motorcycle=4),
...
train_anno = "data/lyft/lyft_info_train.pkl"
val_anno = "data/lyft/lyft_info_val.pkl"
test_anno = None
...
log_level = "INFO"
work_dir = "experiments/8gpus/LYFT_CBGS_detection_20200113-085003"
load_from ="experiments/8gpus/LYFT_CBGS_detection_20200113-085003" 
resume_from = "experiments/8gpus/LYFT_CBGS_detection_20200113-085003/latest.pth"
workflow = [("train", 1)]
