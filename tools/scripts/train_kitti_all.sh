...
# Voxelnet
python -m torch.distributed.launch --nproc_per_node=8 ./tools/train.py examples/second/configs/kitti_all_vfev3_spmiddlefhd_rpn1_mghead_syncbn.py --work_dir=$SECOND_WORK_DIR
