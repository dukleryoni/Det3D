...
OUT_DIR=experiments/nusc_second
...
python -m torch.distributed.launch --nproc_per_node=8 ./tools/train.py examples/second/configs/ohs_local_nusc_car_vfev3_spmiddlefhd_rpn1_mghead_syncbn.py --work_dir=$NUSC_SECOND #--resume_from "experiments/nusc_second/latest.pth"
