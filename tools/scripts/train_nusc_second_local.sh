...
# Voxelnet
python -m torch.distributed.launch --nproc_per_node=4 ./tools/train.py examples/second/configs/local_nusc_car_vfev3_spmiddlefhd_rpn1_mghead_syncbn.py --work_dir=$NUSC_SECOND
