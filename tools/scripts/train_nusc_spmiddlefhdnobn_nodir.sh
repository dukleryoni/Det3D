...
OUT_DIR=experiments/nusc_spmiddlefhdnobn_nodir
...
# Voxelnet
python3.6 -m torch.distributed.launch --nproc_per_node=8 ./tools/train.py examples/cbgs/configs/nusc_all_fev3_spmiddlefhdnobn_rpn2_mghead_syncbn_nodir.py --work_dir=$NUSC_CBGS_WORK_DIR
